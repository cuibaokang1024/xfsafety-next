<template>
  <div class="main">
      ...
      <div class="left-container">
        ...
        <div class="box bot">
          <ul class="list">
            ...
            <li @click="filterOffice(query={isAlert:'13'})">
              <div class="icon signal" />
              <div class="desc">
                <span class="text">信号</span>
                <span class="num-wrapper">
                  <span class="num">
                    <number-roll
                      :width="'10px'"
                      :font-size="'18px'"
                      :number="monitorData.signum"
                      :unit="'套'"
                    />
                  </span>
                </span>
    ...
    <alarm-handle ref="alarmHandle" :dev-category="2" :dev-id="viewDevid" :office-id="viewOfficeId" :is-reset-flag="isDetailResetFlag" />
    <history-alarm ref="historyAlarm" :is-reset-flag="isHistoryResetFlag" :dev-category="2" />
    <el-dialog
      v-if="dialogVisible"
    ...
    >
      ...
      <div class="dialog-content">
        <unit-dev-detail :office-id="viewDevOfficeId" :category="2" :category-name="'smoke'" />
      </div>
...
import { getMonitorData, getOfficeAlert, getOfficeList } from '@/api/smoke'
