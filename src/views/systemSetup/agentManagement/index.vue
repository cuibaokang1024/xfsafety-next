        ...
        <div class="right-container">
          ...
          <div class="table-box">
            <BaseTable
              ...
              :table-height="'100%'"
              :border="false"
              @rowClick="handleAgentView($event, '查看')"
                ...
                <template v-slot="{ row }">
                  <el-tooltip content="修改" placement="top">
                    <el-button
                      ...
                      type="success"
                      circle
                      @click.stop="handleAgentEdit(row, '修改')"
                    />
                  </el-tooltip>
              ...
              >
                ...
                <el-col :span="12">
                  <el-form-item label="联系电话：" prop="officePhone">
                    <el-input
                      v-model="formOption.officePhone"
                      placeholder="请输入联系电话"
                    />
                  </el-form-item>
                </el-col>
                ...
                <el-col v-if="isCentralOffice" :span="12">
                  <el-form-item label="上级代理商：" prop="parentId">
                    <unit-select
                      :is-agent="true"
                      v-model:value="formOption.parentId"
                      v-model:label="formOption.parentName"
                    />
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                  ...
                  <el-form-item label="代理区域：" prop="areaIdList">
                    <div class="treeSelect">
                      ...
                      <el-dialog
                        ...
                        width="350px"
                      >
                        <div name="title" class="dialog-title">代理区域</div>
...
import { deepClone, isOnlyNumber } from '@/utils/index'
...
export default {
  ...
  data () {
    ...
    return {
      ...
      rules: {
        ...
        sort: [{ validator: chkNumber, trigger: 'blur' }]
      },
      title: '',
  ...
  methods: {
    ...
    // 获取列表详情信息
    _getListInfo (data) {
      handlerAgentManaDetail({ id: data.id }).then((res) => {
        this.formOption = res.data
        this.detailData = deepClone(res.data)
        this.agentId =
          res.data.parentId === 10000 ? this.officeId : res.data.parentId
        this.formOption.parentId =
          res.data.parentId === 10000 ? '' : res.data.parentId
        this.formOption.lnglat = res.data.longitude
    ...
    updateData (data) {
      ...
      if (Array.isArray(areaIdList) && areaIdList.length > 0) {
        areaIdList = areaIdList.filter((ele) => {
          return (
            this.detailData.areaIdList.length > 0 &&
            !this.detailData.areaIdList.includes(ele)
          )
        })
      }
      const formData = Object.assign({}, data, {
    ...
    submitData () {
      ...
      if (this.operationStatus !== 'create') {
        ...
        if (this.detailData && this.detailData.areaIdList) {
          ...
          levels = [
            ...new Set(label.concat(this.detailData.areaNames.split(',')))
          ]
        } else {
          data = value
