      ...
      >
        <el-table-column label="单位数" align="center" class-name="small-padding fixed-width">
          <template slot-scope="{ row }">
            <span class="pointer" @click="handleRowDataClick(row, 'sae')">{{ row.office }}</span>
          </template>
        </el-table-column>
        <el-table-column label="设备数" align="center" class-name="small-padding fixed-width">
          <template slot-scope="{ row }">
            <span class="pointer" @click="handleRowDataClick(row, 'ea')">{{ row.sensor }}</span>
          </template>
        </el-table-column>
      </BaseTable>
      <BaseTable
...
import { handleElectricAreaData } from '@/api/bigdata'
...
export default {
  ...
  created() {
    this._handleElectricAreaData()
  },
  methods: {
    // 列表
    _handleElectricAreaData() {
      this.listLoading = true
      handleElectricAreaData().then(res => {
        if (res.data) {
