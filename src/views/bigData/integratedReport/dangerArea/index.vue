      ...
      >
        <el-table-column label="发现隐患" align="center" class-name="small-padding fixed-width">
          <template slot-scope="{ row }">
            <span class="pointer" @click="handleRowDataClick(row, 'da')">{{ row.count }}</span>
          </template>
        </el-table-column>
        <el-table-column label="未整改" align="center" class-name="small-padding fixed-width">
          <template slot-scope="{ row }">
            <span class="pointer" @click="handleRowDataClick(row, 'daf')">{{ row.fixNo }}</span>
          </template>
        </el-table-column>
      </BaseTable>
      <BaseTable
...
import { handleDangerAreaData } from '@/api/bigdata'
...
export default {
  ...
  created() {
    this._handleDangerAreaData()
  },
  methods: {
    // 列表
    _handleDangerAreaData() {
      this.listLoading = true
      handleDangerAreaData().then(res => {
        if (res.data) {
