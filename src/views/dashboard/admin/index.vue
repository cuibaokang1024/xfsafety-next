  ...
  <div class="container home">
    <ul class="main" :class="mainClass">
      <div class="item-map map-wrapper" :class="classNameList[1]">
        <div
          :class="['mark-left', showLeftMark ? 'mark-left-active-right' : 'mark-left-active-left' ]"
          :style=" showLeftMark ? 'left: 0px' : 'left: -207px'"
        >
          <div
            v-if="isShowCategory || isShowOfficeList"
            class="left-list-box"
            @click="isShowLeftMark"
          >
            <i class="el-icon-arrow-right" :style="showLeftMark ? 'transform:rotate(180deg)' : 'transform:rotate(0deg)'" />
            <!-- <div class="box"  /> -->
          </div>
...
import UnitGraded from './components/unitGraded'
import RiskAssess from './components/riskAssess'
import RegionalUnit from './components/regionalUnit'
import HiddenDanger from './components/hiddenDanger'
import BuildingLevel from './components/buildingLevel'
import UnitImplement from './components/unitImplement'
import MeritsRank from './components/meritsRank'
...
export default {
        ...
        series: [
          {
            ...
            radius: ['50%', '70%'],
            center: ['50%', '35%'],
            color: ['#00c0f4', '#8d6cb6', '#c53a32', '#50a03d', '#f08635', '#3878b0', '#85584e', '#d580bc', '#a67b08', '#bebd46', '#f77373'],
            data
          }
        ]
      }
  ...
  methods: {
    ...
    isShowLeftMark() {
      this.showLeftMark = !this.showLeftMark
    }
  }
}
</script>
...
.mark-left {
  ...
  &.mark-left-active-left {
    transition: all 0.6s ease-in-out;
  }
  &.mark-left-active-right {
    transition: all 0.6s ease-in-out;
  }
}
.left-list-box {
